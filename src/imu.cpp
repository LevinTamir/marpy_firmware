// MPU6050 driver + boot-time gyro bias calibration. See imu.h.
#include "imu.h"
...
// Raw read: 14 bytes starting at ACCEL_XOUT_H = accel(6) + temp(2) + gyro(6).
...
bool imu_setup() {
  ...
  // Gyro bias calibration: average GYRO_CALIB_SAMPLES samples while still.
  // Cuts the slow drift any future Madgwick / EKF would otherwise integrate.
